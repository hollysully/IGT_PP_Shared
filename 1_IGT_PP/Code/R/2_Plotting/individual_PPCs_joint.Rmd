...
data = readRDS(here("1_IGT_PP", "Data", "1_Preprocessed", "List_Sess1&2.rds"))
```
...
# Plotting
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckA_Session1_individual_PPC.tiff"),
  ...
  proportions %>% 
    ...
    ggplot(aes(x = binC)) +
      ...
      geom_point(aes(y = choice), size = 1) +
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckA_Session2_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckB_Session1_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckB_Session2_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckC_Session1_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckC_Session2_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckD_Session1_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "Joint", "DeckD_Session2_individual_PPC.tiff"),
     width = 35, height = 35, units = "cm", res = 300)
