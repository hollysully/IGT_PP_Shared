...
write.csv(formatted_correlations, here("1_IGT_PP", "Figs_Tables", "proportion_formatted_correlations.csv"))
```
...
write.csv(formatted_correlations, here("1_IGT_PP", "Figs_Tables", "proportion_formatted_overall_correlations.csv"))
```
...
write.csv(unformatted_correlations, here("1_IGT_PP", "Figs_Tables", "proportion_unformatted_correlations.csv"))
```
