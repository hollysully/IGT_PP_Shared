...
for(i in 1:3500){
  Arew_Rs[i] = pop_correct_MCMC(cor(posterior$Arew[i,,1], posterior$Arew[i,,2]), n_subj = 49, kappa = 1)
  Apun_Rs[i] = pop_correct_MCMC(cor(posterior$Apun[i,,1], posterior$Apun[i,,2]), n_subj = 49, kappa = 1) 
  K_Rs[i] = pop_correct_MCMC(cor(posterior$K[i,,1], posterior$K[i,,2]), n_subj = 49, kappa = 1) 
