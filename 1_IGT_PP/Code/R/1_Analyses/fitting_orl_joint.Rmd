...
saveRDS(choice_proportions,
        here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint",
             "orl_pp_joint_ppcs.rds"))

choice_proportions = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint",
                                  "orl_pp_joint_ppcs.rds"))
```
...
## Reliability
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint", "reliability_coefficients.tiff"),
