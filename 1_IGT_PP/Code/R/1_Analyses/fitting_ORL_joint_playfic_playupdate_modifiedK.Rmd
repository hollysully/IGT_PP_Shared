...
model_code = cmdstan_model(here("1_IGT_PP", "Code", "Stan", 
                                "igt_orl_joint_playfic_playupdate_modifiedK.stan"), compile = F)
...
```{r, eval = F}
# Compile model
orl_model = stan_model(here("1_IGT_PP", "Code", "Stan", "igt_orl_joint_playfic_playupdate_modifiedK.stan"))
...
saveRDS(orl_fit, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
...
```{r}
orl_fit = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
                       "orl_pp_joint_playfic_playupdate_modifiedK_fit.rds"))
...
# saveRDS(orl_posteriors, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
#                              "orl_pp_joint_playfic_playupdate_modifiedK_posteriors.rds"))
orl_posteriors = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
                              "orl_pp_joint_playfic_playupdate_modifiedK_posteriors.rds"))
...
# saveRDS(rhats, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
#                     "orl_pp_joint_playfic_playupdate_modifiedK_rhats.rds"))
rhats = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
                     "orl_pp_joint_playfic_playupdate_modifiedK_rhats.rds"))
```
...
## Traceplots
```{r, eval = F}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
          "orl_pp_joint_playfic_playupdate_modifiedK_group_traceplots.tiff"),
...
for(i in person_parameters){
  tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
            paste("orl_pp_joint_playfic_playupdate_modifiedK_", i, "_traceplots.tiff", sep = "")),
       width = 35, height = 25, units = "cm", res = 300)
    traceplot(orl_fit,
              pars = i
              ) %>% print()
...
```{r, eval = F}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
          "orl_pp_joint_playfic_playupdate_modifiedK_posterior_means.tiff"),
     width = 35, height = 25, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
          "orl_pp_joint_playfic_playupdate_modifiedK_posterior_distributions.tiff"),
...
saveRDS(choice_proportions,
        here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
             "orl_pp_joint_playfic_playupdate_modifiedK_ppcs.rds"))

choice_proportions = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic_playupdate_modifiedK",
                                  "orl_pp_joint_playfic_playupdate_modifiedK_ppcs.rds"))
```
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
          "ORL_joint_playfic_playupdate_modifiedK_PPC.tiff"),
...
correlations %>% 
  ...
  write.csv(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
...
correlations %>% 
  ...
  mutate(lower = as.numeric(str_remove(lower, "\\(")), upper = as.numeric(str_remove(upper, "\\)"))) %>% 
write.csv(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic_playupdate_modifiedK",
               "overall_orl_playfic_playupdate_modifiedK_sr_correlations.csv"))
```
