...
saveRDS(models, here("1_IGT_PP", "Data", "2_Fitted", "binomial_selfreport_fits.RDS"))
```



```{r}
models = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "binomial_selfreport_fits.RDS"))
```
...
```{r}
for(scale in scales){
  tiff(here("1_IGT_PP", "Figs_Tables", "Binomial_SelfReport",
