...
# Check Model
```{r, eval = F}
model_code = cmdstan_model(here("1_IGT_PP", "Code", "Stan", "igt_orl_carryover_joint.stan"), compile = F)
...
```{r, eval = F}
# Compile model
orl_model = stan_model(here("1_IGT_PP", "Code", "Stan", "igt_orl_carryover_joint.stan"))
...
saveRDS(orl_fit, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Carryover_Joint",
                      "orl_pp_carryover_joint_fit.rds"))
```
...
#                              "orl_pp_carryover_joint_posteriors.rds"))
...
#                     "orl_pp_carryover_joint_rhats.rds"))
...
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Carryover_Joint",
          "orl_pp_carryover_joint_group_traceplots.tiff"),
...
for(i in person_parameters){
  tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Carryover_Joint",
            paste("orl_pp_carryover_joint_", i, "_traceplots.tiff", sep = "")),
       width = 35, height = 25, units = "cm", res = 300)
    traceplot(orl_fit,
              pars = i
              ) %>% print()
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Carryover_Joint",
          "orl_pp_carryover_joint_posterior_means.tiff"),
     width = 35, height = 25, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Carryover_Joint",
          "orl_pp_carryover_joint_posterior_distributions.tiff"),
