...
model_code = cmdstan_model(here("1_IGT_PP", "Code", "Stan", 
                                "igt_orl_joint_playfic.stan"), compile = F)
...
```{r, eval = T}
# Compile model
orl_model = stan_model(here("1_IGT_PP", "Code", "Stan", "igt_orl_joint_playfic.stan"))
...
saveRDS(orl_fit, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                      "orl_pp_joint_playfic_fit.rds"))
```



```{r}
orl_fit = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                       "orl_pp_joint_playfic_fit.rds"))
...
saveRDS(orl_posteriors, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                             "orl_pp_joint_playfic_posteriors.rds"))
orl_posteriors = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                              "orl_pp_joint_playfic_posteriors.rds"))
...
saveRDS(rhats, here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                    "orl_pp_joint_playfic_rhats.rds"))
rhats = readRDS(here("1_IGT_PP", "Data", "2_Fitted", "ORL_Joint_playfic",
                     "orl_pp_joint_playfic_rhats.rds"))
```
...
## Traceplots
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
          "orl_pp_joint_playfic_group_traceplots.tiff"),
...
for(i in person_parameters){
  tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
            paste("orl_pp_joint_playfic_", i, "_traceplots.tiff", sep = "")),
       width = 35, height = 25, units = "cm", res = 300)
    traceplot(orl_fit,
              pars = i
              ) %>% print()
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
          "orl_pp_joint_playfic_group_pairs.tiff"),
     width = 35, height = 25, units = "cm", res = 300)
  pairs(
    orl_fit,
    pars = group_parameters
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
          "orl_pp_joint_playfic_posterior_means.tiff"),
     width = 35, height = 25, units = "cm", res = 300)
...
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
          "orl_pp_joint_playfic_posterior_distributions.tiff"),
...
## PPCs
```{r}
tiff(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic", "PPC.tiff"),
     width = 25, height = 10, units = "cm", res = 300)

  grid.newpage()
  pushViewport(viewport(x = .5, y = .5, width = .9, height = .9))
  grid.draw(make_PPCs(orl_fit, stan_data, barbie))
  popViewport()
...
correlations %>% 
  ...
  write.csv(here("1_IGT_PP", "Figs_Tables", "ORL_Joint_playfic",
