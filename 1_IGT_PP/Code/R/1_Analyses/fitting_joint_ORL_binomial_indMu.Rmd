...
```{r}
# SPECIFY SCALE
# finished = "prdep_tot", "masqGDA", "masqAA", "masqGDD"
scale = "masqAD" # "bastot", "basdrive", "basfunsk",
        # "basrewres", "bis", "panas_pa", "panas_na", "shaps_tot"
...
```{r}
orl_fit <- readRDS(here("1_IGT_PP", "Data", "2_Fitted", "Joint_ORL_Binomial", paste("igt_", scale, "_orl_binomial_joint_indMu_fit.rds", sep = "")))
