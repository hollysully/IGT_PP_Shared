...
mu_beta_UT = 0 # slope effect for session
sd_beta_UT = 1  # standard deviation of intercepts
# Westfall Approach
# d = .05
# mu_beta_UT = d * (sum(residual_sd^2, sd_intercept_UT^2, sd_beta_UT^2)) # Westfall et al. approach
...
## Check Model
```{r, eval = F}
model_code = cmdstan_model(here("1_Long_Comp", "Code", "Stan",
                                "RL_Model.stan"),
                           compile = F)
...
```{r}
# Compile model
RL_model = stan_model(here("1_Long_Comp", "Code", "Stan", "RL_Model.stan"))
...
saveRDS(timestamp, here("1_Long_Comp", "Data", "2_Fitted", "RL_Timestamp.RDS"))
saveRDS(RL_fit, here("1_Long_Comp", "Data", "2_Fitted", "RL_Fit.RDS"))
...
```{r}
timestamp = readRDS(here("1_Long_Comp", "Data", "2_Fitted", "RL_Timestamp.RDS"))
RL_fit = readRDS(here("1_Long_Comp", "Data", "2_Fitted", "RL_Fit.RDS"))
