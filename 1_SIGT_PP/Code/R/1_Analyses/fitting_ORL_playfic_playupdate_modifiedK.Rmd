...
model_code = cmdstan_model(here("1_SIGT_PP", "Code", "Stan", 
                                "igt_orl_playfic_playupdate_modifiedK.stan"), compile = F)
...
```{r, eval = T}
# Compile model
orl_model = stan_model(here("1_SIGT_PP", "Code", "Stan", "igt_orl_playfic_playupdate_modifiedK.stan"))
...
saveRDS(orl_fit, here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
...
```{r}
orl_fit = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
                       "orl_playfic_playupdate_modifiedK_pp_fit.rds"))
...
saveRDS(orl_posteriors, here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
                             "orl_playfic_playupdate_modifiedK_pp_posteriors.rds"))
orl_posteriors = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
                              "orl_playfic_playupdate_modifiedK_pp_posteriors.rds"))
...
saveRDS(rhats, here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
                    "orl_playfic_playupdate_modifiedK_pp_rhats.rds"))
rhats = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "ORL_playfic_playupdate_modifiedK",
                     "orl_playfic_playupdate_modifiedK_pp_rhats.rds"))
```
...
## Traceplots
```{r}
tiff(here("1_SIGT_PP", "Figs_Tables", "ORL_playfic_playupdate_modifiedK",
          "orl_playfic_playupdate_modifiedK_pp_group_traceplots.tiff"),
...
for(i in person_parameters){
  tiff(here("1_SIGT_PP", "Figs_Tables", "ORL_playfic_playupdate_modifiedK",
            paste("orl_pp_playfic_playupdate_modifiedK_", i, "_traceplots.tiff", sep = "")),
       width = 35, height = 25, units = "cm", res = 300)
    traceplot(orl_fit,
              pars = i
              ) %>% print()
...
```{r}
tiff(here("1_SIGT_PP", "Figs_Tables", "ORL_playfic_playupdate_modifiedK",
          "orl_playfic_playupdate_modifiedK_pp_posterior_means.tiff"),
     width = 35, height = 25, units = "cm", res = 300)
...
```{r}
tiff(here("1_SIGT_PP", "Figs_Tables", "ORL_playfic_playupdate_modifiedK",
          "orl_playfic_playupdate_modifiedK_pp_posterior_distributions.tiff"),
...
```{r}
tiff(here("1_SIGT_PP", "Figs_Tables", "ORL_playfic_playupdate_modifiedK",
          "ORL_playfic_playupdate_modifiedK_PPC.tiff"),
