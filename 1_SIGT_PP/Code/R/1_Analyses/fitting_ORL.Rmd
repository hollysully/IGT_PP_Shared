...
SIGT1_fit = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "SIGT1_fit.RDS"))
SIGT2_fit = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "SIGT2_fit.RDS"))
SIGT3_fit = readRDS(here("1_SIGT_PP", "Data", "2_Fitted", "SIGT3_fit.RDS"))
```


### Model Comparison
```{r}
SIGT1_loo = SIGT1_fit$loo()
SIGT2_loo = SIGT2_fit$loo()
SIGT3_loo = SIGT3_fit$loo()

loo_model_weights(list("SIGT 1" = SIGT1_loo, "SIGT 2" = SIGT2_loo, "SIGT 3" = SIGT3_loo))

loo_compare(list("SIGT 1" = SIGT1_loo, "SIGT 2" = SIGT2_loo, "SIGT 3" = SIGT3_loo))
```
