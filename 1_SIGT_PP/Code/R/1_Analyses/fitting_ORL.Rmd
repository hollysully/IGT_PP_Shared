...
IGT_fit = ORL_model$sample(data = IGT,
                           ...
                           iter_sampling = 1000,
                           seed = 43210)
IGT_fit$save_object(file = here("Data", "2_Fitted", "IGT_fit.RDS"))
```
...
SIGT1_fit = ORL_model$sample(data = SIGT,
                             ...
                             iter_sampling = 1000,
                             seed = 43210)
SIGT1_fit$save_object(file = here("Data", "2_Fitted", "SIGT1_fit.RDS"))
```
...
SIGT2_fit = ORL_model$sample(data = SIGT,
                             ...
                             iter_sampling = 1000,
                             seed = 43210)
SIGT2_fit$save_object(file = here("Data", "2_Fitted", "SIGT2_fit.RDS"))
```
...
SIGT3_fit = ORL_model$sample(data = SIGT,
                             ...
                             iter_sampling = 1000,
                             seed = 43210)
SIGT3_fit$save_object(file = here("Data", "2_Fitted", "SIGT3_fit.RDS"))
```
