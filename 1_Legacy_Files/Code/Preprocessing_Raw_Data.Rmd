...
check_version = function(data, eprime = T){
  ...
  if(eprime){
    outcome_list = read.csv(here("1_TADS_Parents_PP", "Data", "3_Helper", "eprime_AB_outcome_list.csv")) %>% 
...
IGT_List <- IGT_List[-c(224:238)] #dropping the questionable files
# remove duplicates
...
T1_IGT_mom = TADS_IGT_trim_v %>% 
  ...
  mutate(AB_card = case_when(id == 5139 & card == "A" ~ "AB_A",
                             id == 5222 & card == "B" ~ "AB_B",
                             id == 5198 & card == "D" ~ "AB_D",
                             T ~ AB_card),
         checked_version = case_when(id == 5139 & card == "A" ~ "AB",
                                     id == 5222 & card == "B" ~ "AB",
                                     id == 5198 & card == "D" ~ "AB",
                                     T ~ checked_version))
...
saveRDS(T1_IGT_child,
        here("1_TADS_Raw_Data", "T1_IGT_child.RDS"))
saveRDS(T1_IGT_dad,
        here("1_TADS_Raw_Data", "T1_IGT_dad.RDS"))
saveRDS(T1_IGT_mom,
        here("1_TADS_Raw_Data", "T1_IGT_mom.RDS"))
```
...
saveRDS(T2_IGT_child,
        here("1_TADS_Raw_Data", "T2_IGT_child.RDS"))
saveRDS(T2_IGT_dad,
        here("1_TADS_Raw_Data", "T2_IGT_dad.RDS"))
saveRDS(T2_IGT_mom,
        here("1_TADS_Raw_Data", "T2_IGT_mom.RDS"))
```
...
saveRDS(T3_IGT_child,
        here("1_TADS_Raw_Data", "T3_IGT_child.RDS"))
saveRDS(T3_IGT_dad,
        here("1_TADS_Raw_Data", "T3_IGT_dad.RDS"))
saveRDS(T3_IGT_mom,
        here("1_TADS_Raw_Data", "T3_IGT_mom.RDS"))
```
...
saveRDS(T4_IGT_child,
        here("1_TADS_Raw_Data", "T4_IGT_child.RDS"))
saveRDS(T4_IGT_dad,
        here("1_TADS_Raw_Data", "T4_IGT_dad.RDS"))
saveRDS(T4_IGT_mom,
        here("1_TADS_Raw_Data", "T4_IGT_mom.RDS"))
```
...
saveRDS(T5_IGT_child,
        here("1_TADS_Raw_Data", "T5_IGT_child.RDS"))
saveRDS(T5_IGT_dad,
        here("1_TADS_Raw_Data", "T5_IGT_dad.RDS"))
saveRDS(T5_IGT_mom,
        here("1_TADS_Raw_Data", "T5_IGT_mom.RDS"))
```
...
saveRDS(full_data, here("1_TADS_Raw_Data", "full_IGT.RDS"))

saveRDS(eprime_filenames, here("1_TADS_Raw_Data", "eprime_filenames.RDS"))
```



```{r}
full_data = readRDS(here("1_TADS_Raw_Data", "full_IGT.RDS"))

eprime_filenames = readRDS(here("1_TADS_Raw_Data", "eprime_filenames.RDS"))
```
...
# Find Pbxs
```{r, eval = F}
old_full_data = readRDS(here("1_TADS_Raw_Data", "old_full_IGT_data.RDS"))
